...
def get_model_max_tokens(model):  
    if model == "gpt-35-turbo":  
        ...
        return GPT4_128K_COMPLETIONS_MODEL_MAX_TOKENS  
    else:  
        return GPT35_TURBO_COMPLETIONS_MAX_TOKENS 

def get_encoding_name(model):  
    if model in ["text-search-davinci-doc-001", "text-davinci-003"]:  
        return "p50k_base"  
    elif model in ["text-embedding-ada-002", "gpt-35-turbo", "gpt-4-32k", "gpt-4", "gpt-4-128k"]:   
        return "cl100k_base"  
    else:  
        return "gpt2" 
